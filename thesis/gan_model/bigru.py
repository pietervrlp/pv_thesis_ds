...
def Generator(input_dim, output_dim, feature_size, weight_initializer) -> tf.keras.models.Model:    
    ...
    model.add(Bidirectional(GRU(32, kernel_initializer=weight_initializer, return_sequences=True,
                            dropout = 0.2, recurrent_dropout=0.0,
                            input_shape=(input_dim,feature_size))))
    model.add(LeakyReLU(alpha=0.1))
    #model.add(Bidirectional(GRU(64, activation='relu', kernel_initializer= weight_initializer, return_sequences=True, 
    #                             dropout=0.2, recurrent_dropout=0.0)))
